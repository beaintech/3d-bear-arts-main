...
// Define the types of customizable options for your scene
interface SceneOptions {
  backgroundColor?: THREE.Color | string | number;  // Custom background color
  material: THREE.Material;                        // Custom material for the bear
  bearConfig?: {                                    // Optional bear configuration
...
export function initScene(container: HTMLDivElement, options: SceneOptions): void {
