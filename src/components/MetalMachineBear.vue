...
function createGear(material: any, position: any) {
    ...
    for (let i = 0; i < teethCount; i++) {
        ...
        tooth.position.set(
            (gearRadius + toothDepth / 26) * Math.cos(angle),
            (gearRadius + toothDepth / 26) * Math.sin(angle),
            0
        );
...
.three-canvas {
    ...
    height: 100vh;
    overflow: hidden;
    background: radial-gradient(circle, #222222 60%, #444444 40%);
...
.pixel-btn {
    ...
    box-shadow: 3px 3px 0 #888888, 6px 6px 0 #000000;
...
.pixel-btn:active {
    ...
    box-shadow: 1px 1px 0 #888888, 2px 2px 0 #000000;
}
    </style>
